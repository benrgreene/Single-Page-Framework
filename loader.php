...
function should_ignore_file( $file ) {
  ...
  if( in_array( $file, array( 
    'error.log', 'helpers.php', 'index.php', 'loader.php', 'templates', 'scripts', 'themes', 'api', 'admin', 'node_modules', 'assets', 'package.json', 'webpack.config.js', 'actions-loader.php', 'README.md', 'uploads', 'installed.php'
  ) ) ) {
    $should_ignore = true; 
  }
